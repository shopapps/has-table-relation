...
class BelongsToTable extends Relation
{
     ...
     * @return void
     */
    public function __construct(Builder $query, Model $child, $whichRow = 'first', $ownerKey = null, $relationName = null)
    {
...
//        }
        /*
         * get the whichRow action from the owner table,
         * in my use case there is only 1 record in the table.
         */

        return $this->query->{$this->whichRow}() ?: $this->getDefaultFor($this->parent);
    }
